...
from Change_Settings_For_Backup import ChangeSettingsForBackup
...
class BackupPage:
    def __init__(self, master, window):
        ...
        files_to_include_frame = ttk.LabelFrame(master=master, style="info", text="Files to include")
        ...
        show_current_files_in_cmd_checkbutton = ttk.Checkbutton(master, text="Show files being copied in cmd",
