...
from Change_Settings_For_Button import ChangeButtonSettings
from Assets import Assets
from Update_Configfile import UpdateConfigfile


class ApplicationLauncherGui:
    def __init__(self, master):
        ...
        self.button_container = ttk.Labelframe(self.master, text='Applications', style='info.TLabelframe')
        ...
        self.edit_button = ttk.Checkbutton(master=master, text="Edit buttons", style="warning.Roundtoggle.Toolbutton",
        ...
        self.end_of_lesson_reminder_icon = tk.PhotoImage(file="Assets/Images/End_Of_Lesson_Reminder_Icon_White.png")
    ...
    def open_program(self, index):
        if self.is_editing.get() == 1:
            ...
            ChangeButtonSettings(index, self.master)
        else:
