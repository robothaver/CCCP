...
class Configfile:
    ...
    def set_clock_mode(self):
        ...
        if self.clock_mode == "45_10":
            self.class_start = Assets.class_start_45
            self.class_end = Assets.class_end_45
        elif self.clock_mode == "35_10":
            self.class_start = Assets.class_start_35_10
            self.class_end = Assets.class_end_35_10
        else:
            self.class_start = Assets.class_start_35_5
            self.class_end = Assets.class_end_35_5
