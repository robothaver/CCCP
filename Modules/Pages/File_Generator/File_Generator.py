...
from Modules.Pages.File_Generator.Edit_File_Output_Locations import EditFileOutputLocations
...
class FileGenerator:
    def __init__(self, master):
        ...
        self.file_generator_page = ttk.Frame(master)

        # Define variables
        self.master = self.file_generator_page
        ...
        # Create button frame
        button_frame = ttk.Frame(self.file_generator_page)
        ...
        self.add_output_location_button = ttk.Button(master=self.file_generator_page, text="Add output location",
